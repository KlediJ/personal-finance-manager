...
const TransactionCategorizer_1 = require("../../src/data-processing/ai/TransactionCategorizer");
const QueryProcessor_1 = require("../../src/data-processing/ai/QueryProcessor");
...
let transactionCategorizer = null;
let queryProcessor = null;
// Initialize AI services
const initializeAIServices = async () => {
    if (!transactionCategorizer) {
        transactionCategorizer = new TransactionCategorizer_1.TransactionCategorizer();
    }
    ...
    queryProcessor = new QueryProcessor_1.QueryProcessor(context);
};
// AI Status
...
electron_1.ipcMain.handle('ai:batchCategorizeTransactions', async (event, transactions) => {
    try {
        ...
        const categoryRepo = new CategoryRepository_1.CategoryRepository();
        const availableCategories = categoryRepo.getAll();
        const results = await transactionCategorizer.batchCategorizeTransactions(transactions, availableCategories, (progress) => {
