...
class PayeeExtractor {
     ...
     */
    static suggestCategory(payeeName) {
     ...
     */
    static createPayeeFromDescription(description, defaultCategoryId) {
...
exports.PayeeExtractor = PayeeExtractor;
