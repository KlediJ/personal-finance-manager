...
class TransactionCategorizationService {
     ...
     */
    calculateFuzzyMatchScore(description, payeeName) {
     ...
     */
    getAmountBasedPredictions(amount, availableCategories) {
        const predictions = [];
        ...
        if (absAmount < 10) {
            const entertainmentCategory = availableCategories.find(c => c.name.toLowerCase().includes('entertainment') ||
