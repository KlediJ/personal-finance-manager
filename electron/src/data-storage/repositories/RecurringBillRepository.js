...
exports.BillPaymentRepository = exports.RecurringBillRepository = void 0;
const BaseRepository_1 = require("./BaseRepository");
const RecurringBill_1 = require("../models/RecurringBill");
class RecurringBillRepository extends BaseRepository_1.BaseRepository {
    constructor() {
    ...
    `;
        const statement = this.db.prepare(query);
        const result = statement.get(billId);
        return result?.last_payment_date;
    }
}
exports.RecurringBillRepository = RecurringBillRepository;
class BillPaymentRepository extends BaseRepository_1.BaseRepository {
    constructor() {
        super('bill_payments');
    }
    mapToEntity(row) {
    ...
    markPaymentPaid(paymentId, transactionId, amountPaid) {
        const paymentDate = new Date().toISOString().split('T')[0];
        return this.update(paymentId, {
            status: RecurringBill_1.BillPaymentStatus.PAID,
            transaction_id: transactionId,
            amount_paid: amountPaid,
            payment_date: paymentDate,
        });
    }
    markPaymentOverdue(paymentId, daysLate, lateFee = 0) {
        return this.update(paymentId, {
            status: RecurringBill_1.BillPaymentStatus.OVERDUE,
            days_late: daysLate,
            late_fee: lateFee,
        });
    }
